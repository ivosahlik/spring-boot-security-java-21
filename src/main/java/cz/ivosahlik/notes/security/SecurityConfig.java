package cz.ivosahlik.notes.security;

import cz.ivosahlik.notes.config.OAuth2LoginSuccessHandler;
...
import cz.ivosahlik.notes.security.jwt.AuthEntryPointJwt;
import cz.ivosahlik.notes.security.jwt.AuthTokenFilter;
...
public class SecurityConfig {
    ...
    public CommandLineRunner initData(RoleRepository roleRepository,
        ...
        return args -> {
            ...
            if (Boolean.FALSE.equals(userRepository.existsByUserName("user1"))) {
